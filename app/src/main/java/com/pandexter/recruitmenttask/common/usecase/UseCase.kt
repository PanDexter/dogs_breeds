package com.pandexter.recruitmenttask.common.usecase

import com.pandexter.recruitmenttask.common.schedulers.DefaultSchedulers
import com.pandexter.recruitmenttask.common.schedulers.Schedulers
...
abstract class UseCase<out Type, in Params>(
   ...
   */
  operator fun invoke(parentJob: Job = Job(), params: Params, onResult: (Result<Type>) -> Unit = {}) {
